#!/bin/bash
# planning-with-files: User prompt submit hook for Claude Code
...
# Session gating is handled by the Python adapter. Keep this shell script
# focused on rendering active-plan context so PWF_HOOKS=on/off and temporary
# prompt suppression behave consistently across Claude Code sessions.
